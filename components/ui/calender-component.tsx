...
const defaultCalendarCopy: Dictionary['calendar'] = {
  advanceTicket: '前売り予約',
...
export default function CalendarComponent({
  onDateSelect,
  items,
  dictionary = defaultCalendarCopy,
  ...
  return (
    <div className="flex w-full justify-center p-1 pb-10 pt-4">
      <Calendar
        mode="single"
        selected={date}
